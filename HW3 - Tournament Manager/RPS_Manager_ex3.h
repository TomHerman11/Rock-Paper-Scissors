...
#ifndef RPS_MANAGER_EX3_H_
#define RPS_MANAGER_EX3_H_
...
public:
	Game_Manager():board(), movingPiecesPlayer1(0),movingPiecesPlayer2(0), flagsPlayer1(0), flagsPlayer2(0) {}
	...
	int checkWinnerAfterPosition_ex3();
